...
class TestResults(unittest.TestCase):
    def setUp(self):
        ...
        self.hits_by_region = {1: [TFBSHit('Test1', 1, 'TestSpecies', 'TestLink', 'TestHit', 'TGA', Confidence.STRONG, 1, 10, 10)]}
    ...
    def test_cross_origin_output_features(self):
        hit = TFBSHit(name="Test1", start=20, species="TestSpecies", link="TestLink", description="TestHit", consensus="TGA" * 4,
